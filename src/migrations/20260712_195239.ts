...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_footer_social_links_platform" AS ENUM('facebook', 'instagram', 'youtube', 'twitter');
  CREATE TYPE "public"."enum_homepage_highlight_cards_icon" AS ENUM('school', 'users', 'heart', 'course', 'building', 'help');
  ...
  CREATE TABLE "header" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"cta_label" varchar DEFAULT 'Spenden',
  	"cta_url" varchar DEFAULT '/spenden',
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_name" varchar DEFAULT 'Mosaik Dialog und Kultur e.V.',
  ...
  CREATE TABLE "homepage_highlight_cards" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"icon" "enum_homepage_highlight_cards_icon" DEFAULT 'heart',
  	"title" varchar NOT NULL,
  	"text" varchar,
  	"link" varchar
  );
  ...
  CREATE TABLE "donation_impact_cards" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar NOT NULL,
  ...
  CREATE TABLE "contact_info" (
  	...
  	"phone" varchar,
  	"email" varchar,
  	"office_hours_weekday" varchar,
  	"office_hours_weekend" varchar,
  ...
  ALTER TABLE "homepage_highlight_cards" ADD CONSTRAINT "homepage_highlight_cards_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."homepage"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "donation_impact_cards" ADD CONSTRAINT "donation_impact_cards_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "donation_impact_cards" ADD CONSTRAINT "donation_impact_cards_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."donation"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "homepage_highlight_cards_order_idx" ON "homepage_highlight_cards" USING btree ("_order");
  CREATE INDEX "homepage_highlight_cards_parent_id_idx" ON "homepage_highlight_cards" USING btree ("_parent_id");
  CREATE INDEX "donation_impact_cards_order_idx" ON "donation_impact_cards" USING btree ("_order");
  CREATE INDEX "donation_impact_cards_parent_id_idx" ON "donation_impact_cards" USING btree ("_parent_id");
  CREATE INDEX "donation_impact_cards_image_idx" ON "donation_impact_cards" USING btree ("image_id");`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "homepage_highlight_cards" CASCADE;
  DROP TABLE "homepage" CASCADE;
  DROP TABLE "donation_impact_cards" CASCADE;
  DROP TABLE "donation" CASCADE;
  DROP TABLE "contact_info" CASCADE;
  DROP TYPE "public"."enum_footer_social_links_platform";
  DROP TYPE "public"."enum_homepage_highlight_cards_icon";`)
}
